...
**Criteria:** When grouping spans by `trace_id`, each trace MUST NOT have more than 20 spans within a single trace have a `duration` of less than 5 milliseconds.
